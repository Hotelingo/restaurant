...
class CalcWorkerUnitTests(unittest.TestCase):
    ...
    def test_full_pl_bundle_contains_actual_comparator_and_variance(self) -> None:
        ...
        self.assertEqual(sequence.calculation_status, "CALCULATED")
        self.assertEqual(sequence.metadata["impact"], Decimal("-3500"))
        self.assertEqual(sequence.metadata["materiality_reasons"], ("amount_test",))
        self.assertEqual(sequence.metadata["materiality_snapshot_id"], "mat-general-v1")
    ...
    def test_missing_comparator_is_persisted_as_not_calculated_not_zero(self) -> None:
        ...
        self.assertEqual(sequence.explanation_code, "NO_CALCULATED_VARIANCES")
